...
|---|---|---|
| `wave1.py` | `the original source checkout` | `7558da7cc2bc2d7b57b1f770d4a9078e35f791afd7e910e70bb2e03def764c6a` |
| `wave2.py` | `the original source checkout` | `7e7a7214795c6d03c9c4366521c5b7ac9456fd21a0c1ddb4b2a9f7b980230117` |

Migrated on 2026-07-11. The copied fixture/scorer content was unchanged during migration. Future changes must be made here with regression tests; `the original source location` is no longer an executable dependency.
